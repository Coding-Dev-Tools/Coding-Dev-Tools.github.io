Portfolio Link-Integrity Audit - 2026-07-17T22:15:37Z
...
OK (resolves locally): **206**
BROKEN (404 on live site): **101 unique targets** (771 total references)
LIVECHECK (verify live): 2 unique targets
...
| `coding-dev-tools.github.io/devforge/pricing.html` | 14 | 6 | `Coding-Dev-Tools.github.io\blog\datamorph-schema-validation-in-ci.html`, `datamorph\README.md`, `devforge-fix\README.md`, +3 more |
| `coding-dev-tools.github.io/devforge/about.html` | 12 | 5 | `devforge-fix\README.md`, `devforge-fix\about.html`, `devforge-fix\blog\deadcode-remove-dead-code-nextjs-app-router.html`, +2 more |
| `coding-dev-tools.github.io/devforge/blog.html` | 10 | 4 | `devforge-fix\README.md`, `devforge-fix\blog.html`, `devforge-fix\blog\license-key-rate-limiting-cli-tools.html`, +1 more |
...
| `coding-dev-tools.github.io/devforge/docs.html` | 8 | 4 | `devforge-fix\README.md`, `devforge-fix\blog\license-key-rate-limiting-cli-tools.html`, `devforge-fix\docs.html`, +1 more |
...
| `coding-dev-tools.github.io/revenueholdings.dev/index.html` | 6 | 3 | `SaaS-Churn-Predictor\README.md`, `apiauth\README.md`, `json2sql\README.md` |
...
| `coding-dev-tools.github.io/devforge.dev/index.html` | 3 | 2 | `.github\README.md`, `.github\profile\README.md` |
...
| `coding-dev-tools.github.io/devforge.dev/pricing.html` | 2 | 1 | `.github\README.md` |
| `coding-dev-tools.github.io/devforge.dev/docs.html` | 2 | 1 | `.github\README.md` |
| `coding-dev-tools.github.io/devforge.dev/blog.html` | 2 | 1 | `.github\README.md` |
| `coding-dev-tools.github.io/devforge.dev/about.html` | 2 | 1 | `.github\profile\README.md` |
...
| `coding-dev-tools.github.io/revenueholdings.dev/blog/openapi-diff-tools-comparison.html` | 1 | 1 | `devforge-fix\sitemap.xml` |
| `coding-dev-tools.github.io/devforge/blog/traction-hits-680-developers.html` | 1 | 1 | `devforge-fix\sitemap.xml` |
| `coding-dev-tools.github.io/revenueholdings.dev/alternatives.html` | 1 | 1 | `devforge-fix\sitemap.xml` |
| `coding-dev-tools.github.io/revenueholdings.dev/quickstart.html` | 1 | 1 | `devforge-fix\sitemap.xml` |
| `coding-dev-tools.github.io/revenueholdings.dev/blog/clean-up-react-dead-code.html` | 1 | 1 | `devforge-fix\sitemap.xml` |
...
- `revenueholdings.dev/index.html` -- referenced by 8 file(s): `Coding-Dev-Tools.github.io\blog\django-models-to-prisma-migration.html`, `Coding-Dev-Tools.github.io\blog\sqlalchemy-to-prisma-migration.html`, `Coding-Dev-Tools.github.io\configdrift.html`
...
- **`devforge.dev` slug 404s (6 targets):** `.github/README.md` and `.github/profile/README.md` link to `coding-dev-tools.github.io/devforge.dev/...` but the real slug is `devforge` (no `.dev`). Repoint those links to `coding-dev-tools.github.io/devforge/`.
...
---
Generated by `tools/linkcheck_portfolio.py` at 2026-07-17T22:15:37Z. Re-run each tick; commit the report so the backlog stays fresh.
